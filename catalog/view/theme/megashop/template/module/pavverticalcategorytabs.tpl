<?php
$span = 12/$cols;
$id = rand(1,999)+substr(md5($heading_title),0,3);
...
<div class="box pav-verticalcategorytabs clearfix <?php echo $prefix_class; ?>">
	...
	<div class="box-wapper <?php echo $prefix_class ?> clearfix">
		<div class="tab-nav tabs-x tabs-<?php echo $tab_position;?>">
			...
			<ul class="nav nav-tabs " id="pavo-categorytabs<?php echo $id;?>" role="tablist">
                <li class="nav-header box-heading">
                    <span><?php echo $category_name; ?></span>
                    <?php if( !empty($module_description) ) { ?>
                    <?php } ?>
                </li><!-- end div.box-heading -->
				<?php foreach ($tabs as $key=>$tab): ?>
				<li class="vertical-list-item"><a href="#tab<?php echo $id."-cat".$key;?>" role="tab" data-toggle="tab"><?php echo $tab['name']; ?></a></li>
				<?php endforeach; ?>
			</ul>
...
$(function() {
	...
	$('#pavo-categorytabs<?php echo $id;?> a:first').tab('show');
});
</script>
