<?php
/******************************************************
 * @package Pav Opencart Theme Framework for Opencart 2.x
 * @version 2.0
...
$headerlayouts = array('hasmainmenu' => 'Main Menu','menusearch' => 'Mainmenu-Search','hasverticalmenu'=>'Has Verticalmenu' );
$productlayouts  =	array( 'default' => 'Default', 'product-variant' => 'Product Variant');
?>
        ...
        <div class="panelcontent ">
            <div class="    panelinner">
                ...
                <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" class="clearfix"><div class="clearfix">
                        ...
                        <div class="group-input row">
                            <label class="col-sm-5" >Header Layout</label>
                            <select class="col-sm-7" name="userparams[headerlayout]">
                        ...
                        <p class="group-input pull-right">
                            <button value="Apply" class="btn btn-outline" name="btn-save" type="submit">Apply</button>
                            <a class="btn btn-inverse" href="<?php echo HTTP_SERVER; ?>?pavreset=?"><span>Reset</span></a>
                        </p>
                    </div></form>
            </div>
        </div>
                            ...
                            <div class="accordion-group panel panel-default">
                                ...
                                <div id="collapse<?php echo $group['match'];?>" class="accordion-body panel-collapse collapse <?php if( $i++ ==0) { ?> in <?php } ?>">
                                    <div class="accordion-inner panel-body clearfix">
                                        ...
                                        <div class="form-group">
                                            <label><?php echo $item['label']?></label>
                                            <input value="" size="10" name="customize[<?php echo $group['match']?>][]" data-match="<?php echo $group['match']?>" type="text" class="input-setting" data-selector="<?php echo $item['selector']?>" data-attrs="<?php echo $item['attrs']?>"><a href="#" class="clear-bg btn btn-outline-small">Clear</a>
                                        </div>
                                        <?php } ?>
