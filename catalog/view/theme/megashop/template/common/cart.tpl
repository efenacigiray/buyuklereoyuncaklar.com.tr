<div id="cart" class="btn-group btn-block">
    <div data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="heading dropdown-toggle">
        <div class="cart-inner pull-right">
            ...
            <a><span id="cart-total"><?php echo $text_items; ?><i class="fa fa-angle-down"></i></span></a>
        </div>
    </div>
    <ul class="dropdown-menu pull-right content">
        ...
        <li>
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td class="text-left"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
                        ...
                        <?php } ?></td>
                    <td class="text-right multiplier">x <?php echo $product['quantity']; ?></td>
          ...
          <td class="text-center"><button type="button" onclick="cart.remove('<?php echo $product['cart_id']; ?>');" title="<?php echo $button_remove; ?>" class="btn btn-danger btn-xs"><i class="fa fa-times"></i></button></td>
                ...
                <tr>
                    ...
                    <td class="text-center text-danger"><button type="button" onclick="voucher.remove('<?php echo $voucher['key']; ?>');" title="<?php echo $button_remove; ?>" class="btn btn-link btn-xs"><i class="fa fa-times"></i></button></td>
                </tr>
                <?php } ?>
            </table>
        </li>
        <li>
            <div>
                ...
                <p class="text-right">
                    <a href="<?php echo $cart; ?>" class="btn btn-inverse">
                        <?php echo $text_cart; ?>
                    </a>&nbsp;&nbsp;&nbsp;
                    <a href="<?php echo $checkout; ?>" class="btn btn-outline">
