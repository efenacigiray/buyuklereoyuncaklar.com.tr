...
<div class="product-block item-default clearfix" itemtype="http://schema.org/Product" itemscope>
    ...
    <span class="product-label ribbon label-special">
        <span class="product-label-special"><?php echo $olang->get( 'text_sale'); ?></span></span>
    <?php } ?>
    <div class="images clearfix">
        ...
        <a class="pav-colorbox btn btn-inverse iframe-link" data-toggle="tooltip" href="<?php echo $ourl->link('themecontrol/product','product_id='.$product['product_id']);?>"  title="<?php echo $olang->get('quick_view'); ?>" >
            <i class="fa fa-eye"></i>
        </a>
        <?php } ?>
        <?php if( isset($categoryPzoom) && $categoryPzoom ) { $zimage = str_replace( "cache/","", preg_replace("#-\d+x\d+#", "",  $product['thumb'] ));  ?>
        <a href="<?php echo $zimage;?>" class="btn btn-inverse colorbox product-zoom cboxElement" title="<?php echo $product['name']; ?>">
        ...
        <div class="product-meta-inner">
            ...
            <div class="right">
                <div class="action">
                    ...
                    <div class="cart">
                        <button data-loading-text="Yükleniyor..." class="btn btn-outline" type="button" onclick="cart.addcart('<?php echo $product['product_id']; ?>');">
