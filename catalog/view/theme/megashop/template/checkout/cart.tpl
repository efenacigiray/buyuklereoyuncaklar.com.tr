...
<div class="container">
  ...
  <div class="row"><?php if( $SPAN[0] ): ?>
   ...
   <section id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>"><div id="content" class="wrapper clearfix"><?php echo $content_top; ?>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-left"><div class="input-group btn-block input-checkout-cart" style="max-width: 200px;">
      ...
      <div class="buttons">
        <div class="pull-left" id="shopping-btn"><a href="<?php echo $continue; ?>" class="btn btn-default"><?php echo $button_shopping; ?></a></div>
        <div class="pull-right" id="checkout-btn"><a href="<?php echo $checkout; ?>" class="btn btn-outline"><?php echo $button_checkout; ?></a></div>
      </div>
