...
class ModelCheckoutOrder extends Model {
	public function addShippingCode($order_id, $shipping_follow_code) {
		$this->db->query("UPDATE " . DB_PREFIX . "order SET shipping_follow_code = '" . $this->db->escape($shipping_follow_code) . "' WHERE order_id = '" . $this->db->escape($order_id) . "' LIMIT 1");
	}
