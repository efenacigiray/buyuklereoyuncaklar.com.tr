...
class ControllerModulePavverticalcategorytabs extends Controller {
	...
	public function index($setting) {
		...
		$this->load->model('pavverticalcategorytabs/categorytabs');
		...
		$this->mdata['limit_tabs']   = (int)$setting['limit_tabs'];
		...
		$sub_categories = $this->model_pavverticalcategorytabs_categorytabs->getCategories($category_id,$setting['limit_tabs']);
