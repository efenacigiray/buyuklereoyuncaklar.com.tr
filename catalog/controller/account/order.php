...
class ControllerAccountOrder extends Controller {
	...
	public function info() {
		...
		if ($order_info) {
			...
			if (isset($order_info['shipping_follow_code']) && !empty($order_info['shipping_follow_code'])) {
				$data['shipping_follow_code'] = $order_info['shipping_follow_code'];
			} else {
				$data['shipping_follow_code'] = false;
			}
