...
class ControllerthemecontrolProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/themecontrol/product.tpl')) {
				$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/themecontrol/product.tpl', $data));
			} else {
				$this->response->setOutput($this->load->view('default/template/themecontrol/product.tpl', $data));
			}
		} else {
			$url = '';
