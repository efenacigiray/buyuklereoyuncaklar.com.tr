...
class ControllerProductManufacturer extends Controller {
	public function index() {
		...
		foreach ($results as $result) {
			...
			if ($result['image']) {
				$data['image'] = $this->model_tool_image->resize($result['image'], 150, 150);
			} else {
				$data['image'] = $this->model_tool_image->resize('catalog/logo.png', 150, 150);;
			}
	...
	public function info() {
		...
		if ($manufacturer_info) {
			...
			if ($manufacturer_info['image']) {
				$data['manufacturer_image'] = $this->model_tool_image->resize($manufacturer_info['image'], 110, 110);
			} else {
				$data['manufacturer_image'] = $this->model_tool_image->resize('placeholder.png', 110, 110);
			}
