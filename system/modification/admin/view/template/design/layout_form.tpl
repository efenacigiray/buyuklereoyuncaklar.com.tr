...
function addModule() {
    ...
    html += '  </select></td>'; 
				...
				html += '    <option value="slideshow"><?php echo ucfirst('slideshow'); ?></option>';
				html += '    <option value="promotion"><?php echo ucfirst('promotion'); ?></option>';
				html += '    <option value="showcase"><?php echo ucfirst('showcase'); ?></option>';
				html += '    <option value="mass_bottom"><?php echo ucfirst('Mass Bottom'); ?></option>';
				html += '    <option value="footer_top"><?php echo ucfirst('Footer Top'); ?></option>';
				html += '    <option value="footer_center"><?php echo ucfirst('Footer Center'); ?></option>';
				html += '    <option value="footer_bottom"><?php echo ucfirst('Footer Bottom'); ?></option>';
        html += '    <option value="outsite_right"><?php echo ucfirst('Out Site right'); ?></option>';
        html += '    <option value="outsite_left"><?php echo ucfirst('Out Site left'); ?></option>';
