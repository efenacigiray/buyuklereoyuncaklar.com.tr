        ...
        ************   Navigation / Router   ************
        ...
        app.router = {
            ...
            animatePages: function (leftPage, rightPage, direction, view) {
                ...
                if (direction === 'to-left') {
                    leftPage.removeClass(removeClasses).addClass('pt-page-moveToLeftEasing');
                    rightPage.removeClass(removeClasses).addClass('pt-page-scaleUp');
                }
                // Go back
        ...
        app.router._load = function (view, options) {
            ...
            function afterAnimation() {
                view.allowPageChange = true;
                newPage.removeClass('pt-page-scaleUp page-on-right page-on-left').addClass('page-on-center');
                oldPage.removeClass('pt-page-moveToLeftEasing page-on-center page-on-right').addClass('page-on-left');
                if (dynamicNavbar) {
