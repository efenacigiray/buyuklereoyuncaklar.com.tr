											...
											<div class="tab-pane" id="tab-module<?php echo $module_row; ?>-language<?php echo $language['language_id']; ?>">
												<table class="table">
													<tr>
														...
														<td class="col-sm-10"><textarea class="pavo-editor" name="pavverticalcategorytabs_module[<?php echo $module_row; ?>][ ][<?php echo $language['language_id']; ?>]" id="input- -<?php echo $module_row; ?>-language-<?php echo $language['language_id']; ?>"><?php echo isset($module[' '][$language['language_id']]) ? $module[' '][$language['language_id']] : ''; ?></textarea></td>
													</tr>
												</table>
											</div>
											<?php } ?>
