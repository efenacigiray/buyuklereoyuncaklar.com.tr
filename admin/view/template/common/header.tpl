...
<script type="text/javascript" src="view/javascript/dropzone.js"></script>
...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    ...
    <?php } ?>
    <a href="<?php echo $home; ?>" class="navbar-brand"><img style="height: 65px; position: absolute; top: -10px;" src="http://www.buyuklereoyuncaklar.com.tr/image/cache/catalog/logo-45x45.png"></a></div>
  <?php if ($logged) { ?>
