...
$('#button-upload').on('click', function() {
	...
	$('body').prepend('<form enctype="multipart/form-data" id="form-upload" style="display: none;"><input type="file" id="file_uploader" name="files[]" multiple value="" /></form>');
	...
	timer = setInterval(function() {
		if ($('#file_uploader').val() != '') {
			...
			$.ajax({
				url: 'index.php?route=common/filemanager/multiupload&token=<?php echo $token; ?>&directory=<?php echo $directory; ?>',
				type: 'post',
				dataType: 'json',
