<?php 
 ...
 $query['pavverticalmenu'][]="CREATE TABLE IF NOT EXISTS  `".DB_PREFIX."verticalmenu` (
 ...
 $query['pavverticalmenu'][]="CREATE TABLE IF NOT EXISTS  `".DB_PREFIX."verticalmenu_description` (
 ...
 $query['pavverticalmenu'][]="CREATE TABLE IF NOT EXISTS  `".DB_PREFIX."verticalmenu_widgets` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(250) NOT NULL,
  `type` varchar(255) NOT NULL,
  `params` text NOT NULL,
 ...
 $query['pavmap'][]="CREATE TABLE IF NOT EXISTS  `".DB_PREFIX."pavmap_group_location` (
 ...
 $query['pavmap'][]="CREATE TABLE IF NOT EXISTS  `".DB_PREFIX."pavmap_location` (
 ...
 $query['pavmap'][]="CREATE TABLE IF NOT EXISTS  `".DB_PREFIX."pavmap_location_description` (
